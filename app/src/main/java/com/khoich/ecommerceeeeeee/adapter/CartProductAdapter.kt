...
import com.khoich.ecommerceeeeeee.databinding.CartProductItemBinding
    ...
    inner class CartProductsViewHolder(val binding: CartProductItemBinding) :
        ...
        fun bind(cartProduct: CartProduct) {
            binding.apply {
                ...
                val textProductCartPrice = "$ ${String.format("%.2f", priceAfterPercentage)}"
                tvProductCartPrice.text = textProductCartPrice
