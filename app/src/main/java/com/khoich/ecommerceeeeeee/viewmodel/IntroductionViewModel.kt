...
import com.khoich.ecommerceeeeeee.util.Constants.INTRODUCTION_KEY
...
class IntroductionViewModel @Inject constructor(
    ...
    private val _navigate = MutableStateFlow(124)
    ...
    // sang viewModel thì nó sẽ vào hàm init này đầu tiên trước
    init {
